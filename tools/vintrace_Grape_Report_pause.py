#  python tools/vintrace_Grape_Report_pause.py
import os
import shutil
...
try:
    ...
    # ========== STOP BEFORE GENERATING REPORT ==========
    input("\nPaused for debugging. The browser is still open. Press Enter to continue (and generate the report)...\n")
    # ========== Uncomment below to continue report generation ==========
    ...
    # Comment out driver.quit() so the browser stays open
    # driver.quit()
    pass

print(f"Ready for debugging. The browser will remain open for inspection.")