...
# python tools/fetch_Vessels_liveMetrics.py
...
if __name__ == "__main__":
    ...
    output_path = os.path.join(output_dir, "vessels_liveMetrics.json")
    ...
    sample_output_path = os.path.join(output_dir, "vessels_sample_liveMetrics.json")
